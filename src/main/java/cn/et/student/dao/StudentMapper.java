...
public interface StudentMapper {
	@Select("select max(sid)+1 id from student")
    int selectMaxSid();
    ...
    @Insert({
        ...
        "#{gid,jdbcType=INTEGER}, #{ssex,jdbcType=INTEGER}, #{saddress,jdbcType=VARCHAR})"
    })
    ...
    @Results({
        ...
        @Result(column="ssex", property="ssex", jdbcType=JdbcType.INTEGER),
