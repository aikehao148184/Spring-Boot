...
public class StudentSqlProvider {
    ...
    public String insertSelective(Student record) {
        ...
        if (record.getSsex() != null) {
            sql.VALUES("ssex", "#{ssex,jdbcType=INTEGER}");
        }
        
        if (record.getSaddress() != null) {
            sql.VALUES("saddress", "#{saddress,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getSsex() != null) {
            sql.SET("ssex = #{record.ssex,jdbcType=INTEGER}");
        }
        
        if (record.getSaddress() != null) {
            sql.SET("saddress = #{record.saddress,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Student record) {
        ...
        if (record.getSsex() != null) {
            sql.SET("ssex = #{ssex,jdbcType=INTEGER}");
        }
        
        if (record.getSaddress() != null) {
            sql.SET("saddress = #{saddress,jdbcType=VARCHAR}");
        }
